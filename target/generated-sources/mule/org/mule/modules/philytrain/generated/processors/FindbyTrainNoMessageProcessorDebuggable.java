...
public class FindbyTrainNoMessageProcessorDebuggable
    extends FindbyTrainNoMessageProcessor
    implements DebugInfoProvider
{


    public FindbyTrainNoMessageProcessorDebuggable(String operationName) {
        super(operationName);
    }
    ...
    public List<FieldDebugInfo<?>> getDebugInfo(MuleEvent muleEvent) {
        ...
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("trainNo", "Train no", (java.lang.String.class), trainNo, muleEvent));
